...
import { BookOpen, Shield, Heart, Users, Sun, Moon, Star, HandHelping, UserSquare, DollarSign, Briefcase, Gift, ShoppingCart, Building } from 'lucide-react';

export const askPrayerTemplates: PrayerTemplate[] = [
  {
    id: 'ask-template-1',
  ...
  },
  {
    ...
    points: [
      ...
      { title: "Thank God for the precious and indescribable gift of the Holy Spirit, who is our Comforter, Advocate, Intercessor, Counselor, Strengthener and Standby.", duration: 1 },
      { title: "Thank God for the grace of our Lord Jesus Christ that bestows the same favour upon us that was on the Lord Jesus Christ and His ministry, and for the authority of His name by which we overcome all the power of the enemy.", duration: 1 },
    ],
  },
  {
    id: 'ask-template-3',
    ...
    points: [
      ...
      { title: "Break every curse, every spell, and every hex that has been pronounced against you and your family in the authority of the name of the Lord Jesus Christ.", duration: 1 },
      { title: "Break every fetter, every chain and every tether tying you and your family to any demonic altars that keep you in demonic cycles of failure regression and stagnation. Decree and declare the victory of Christ over them and remind Satan that he has fallen from heaven.", duration: 1 },
      { title: "Pronounce God's curse of death upon every witch, every warlock, every wizard and every sorcerer, and remind God of HIS covenant promise to bless those who bless you and to curse those who curse you.", duration: 1 },
    ],
  },
  {
    id: 'ask-template-4',
    ...
    points: [
      ...
      { title: "Ask God to protect us from deception by keeping us rooted and established in HIS Word through faith that is alive.", duration: 1 },
      { title: "Ask God to grant us the foreknowledge, spiritual awareness and fortitude to know when we are under demonic attack, and to respond with the faith, temperament, and perseverance of the Lord Jesus Christ.", duration: 1 },
      { title: "Ask God to help us grow and increase our faith in the Lord Jesus Christ so that we may have strength and perseverance in times of trials and tests.", duration: 1 },
    ],
  },
  {
    id: 'ask-template-5',
    ...
    points: [
      ...
      { title: "Bind every disease and sickness-causing demon, and command them to get out of you and your family's lives. Bind every witch, every warlock, every wizard and every sorcerer that is warring against your health. Decree and declare that their power and authority over our lives has been paralyzed in the name of Jesus Christ.", duration: 1 },
      { title: "Bind and break every hex, every spell and every disease and sickness-causing curse, and render them paralyzed in you and your family's lives. Decree and declare that sickness no longer has dominion over you and your family's lives because you have the health of the Lord Jesus Christ.", duration: 1 },
      { title: "Praise the Lord and give thanks for your healing and for the renewal of your youth like that of the eagle's.", duration: 1 },
    ],
  },
  {
    id: 'ask-template-6',
